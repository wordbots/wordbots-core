            ...
            >
              {
                recentCards.map((card, idx) =>
                  ...
                  >
                    ...
                    <CardProvenanceDescription card={card} style={{ position: 'relative', top: 20, fontSize: 10.5, color: '#888', maxWidth: 140, padding: '1px 3px', background: `rgba(255, 255, 255, 0.8)`, borderRadius: 5 }} />
                  </div>
                )
              }
            </Carousel>
