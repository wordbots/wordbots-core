    ...
    return (
      ...
      >
        ...
        <DialogContent>
          ...
          <p>This tutorial should take just 3 to 5 minutes to complete and will teach you all the basic gameplay mechanics required to play the game of Wordbots, including how to place robots and structures onto the board, how to use events to tilt the game in your favor, and the basic steps that go into each turn of Wordbots.</p>
