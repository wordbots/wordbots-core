...
function createDeck(cardCounts: Array<[w.CardInStore, number]>): w.CardInStore[] {
...
export const aggro: w.CardInStore[] = createDeck([
  // Robots (22)
...
export const healing: w.CardInStore[] = createDeck([
  // Robots (17)
