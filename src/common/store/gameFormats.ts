...
export class GameFormat {
  ...
  public startGame(
    ...
    _decks: w.PerPlayer<Array<w.CardInGame | w.ObfuscatedCard>>, options: w.GameOptions, seed: string
  ): w.GameState {
...
export const NormalGameFormat = new (class extends GameFormat {
  ...
  public startGame(
    state: w.GameState, player: w.PlayerColor, usernames: w.PerPlayer<string>,
    decks: w.PerPlayer<Array<w.CardInGame | w.ObfuscatedCard>>, options: w.GameOptions, seed: string
  ): w.GameState {
